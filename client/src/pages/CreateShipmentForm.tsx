      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            />
            {errors.origin_code && (
              <span className="text-red-500 text-sm">{errors.origin_code}</span>
            )}
          </div>
          <div>
            <label
            ...
            />
            {errors.origin_city && (
              <span className="text-red-500 text-sm">{errors.origin_city}</span>
            )}
          </div>
          <div>
            <label
        ...
        <div>
          ...
          />
          {errors.cargo_load && (
            <span className="text-red-500 text-sm">{errors.cargo_load}</span>
          )}
        </div>
